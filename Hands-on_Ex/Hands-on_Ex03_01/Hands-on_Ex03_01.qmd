...
![](Data/Screenshot%202025-01-30%20223104.png)
...
![](Data/Screenshot%202025-01-30%20Tips.png)
...
mutate_each\_() was deprecated in dplyr 0.7.0. and funs() was deprecated in dplyr 0.8.0. In view of this, we will re-write the code by using mutate_at() as shown in the code chunk below.
...
![](Data/Screenshot%202025-01-30_3.png)
...
bp <- globalPop %>%
  ...
  layout(
    title = "Aging vs Young Population",
    xaxis = list(title = "% Aged"),
    yaxis = list(title = "% Young"),
    showlegend = TRUE
  ) %>%
  animation_opts(frame = 100, easing = "linear") %>%
