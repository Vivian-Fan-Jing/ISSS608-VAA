...
switch tmap’s Viewer back to plot mode by using the code chunk below. It might affect subsequent plots in your session if we leave it in "view" mode.
...
-   Choropleth Mapping with R](https://r4va.netlify.app/chap21)

-   (https://r4va.netlify.app/chap23)
