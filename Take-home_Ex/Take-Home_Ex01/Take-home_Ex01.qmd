...
### 2.2.2 Measure BMI and stress level variables
...
```{r}
ggplot(heart_data, aes(x = Alcohol_Consumption, fill = Heart_Attack_Occurrence)) +
  geom_bar(position = "fill") +
  facet_wrap(~ Smoking_History) +  # Check across different age groups
