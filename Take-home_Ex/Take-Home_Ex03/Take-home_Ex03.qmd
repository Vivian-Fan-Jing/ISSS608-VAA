...
pacman::p_load(tidyverse,readxl,ggcorrplot, ggstatsplot, GGally,
              ...
              ggExtra,parallelPlot,treemap, treemapify, tidyverse,tibble, d3treeR,ggiraph,ggstatsplot,ggdist, ggridges, ggthemes,
               colorspace)
```
...
# 4. Plot Marginal Density Function

## 4.1 Simple scatterplot between Level of water stress (%) and Water Productivity (US\$ GDP per m³) by region

### 4.1.1 African Region
...
### 4.1.4 Eastern Mediterranean Region
...
## 4.2 Simple scatterplot between basic drinking water services (%) and safely managed drinking water services (%) by region
...
### 4.2.4 Eastern Mediterranean Region
...
## 4.3 Simple scatterplot between basic sanitation services (% of population) and safely managed sanitation services (% of population)

### 4.3.1 African Region
...
### 4.3.4 Eastern Mediterranean Region
...
# 6. Distribution Analysis (Density Plot)
...
## 7.1 People using at least basic sanitation services (% of population)
...
## 7.2 People using safely managed sanitation services (% of population)
...
## 7.3 People using at least basic drinking water services (% of population)
...
## 7.4 People using safely managed drinking water services (% of population)
...
## 7.5 Water productivity, total (constant 2015 US\$ GDP per cubic meter of total freshwater withdrawal)
...
## 7.6 Level of water stress: freshwater withdrawal as a proportion of available freshwater resources
...
## 7.7 People practicing open defecation (% of population)
...
## 7.8 People with basic handwashing facilities including soap and water (% of population)
